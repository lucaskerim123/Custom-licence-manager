...
const groups=[
 ...
 {label:'System',items:[['products','/products','Products'],['users','/users','Users'],['operations','/operations','Operations'],['settings','/settings','System Settings'],['api','/api-docs','API Contract']]}
] as const;
